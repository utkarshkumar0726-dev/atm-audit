                              ...
                              return (
                                <a
                                  ...
                                  style={{
                                    ...
                                    padding: '3px 7px',
                                    borderRadius: 5,
                                    background: isBom ? '#fef3c7' : '#e0f2fe',
                                    color: isBom ? '#b45309' : '#0369a1',
                                    fontSize: '0.76rem',
                                    fontWeight: 600,
                                    textDecoration: 'none',
                                    border: isBom ? '1px solid #fde68a' : 'none',
                                  }}
                                  title={isBom ? 'BOM (Bill of Materials) Document' : `Open Link ${arr.length > 1 ? `#${i + 1}` : ''}`}
                                >
                                  {isBom ? '📄 BOM' : (arr.length > 1 ? `🔗 Link ${i + 1}` : '🔗 View')} ↗
                                </a>
                              );
                            })}
                          </div>
